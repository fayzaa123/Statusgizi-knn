        ...
        <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div class="notification-slider">
                <div class="d-flex h-100"> <img src="{{ asset('images/giftools.gif') }}" alt="gif">
                    <h6 class="mb-0 f-w-400"><span class="font-primary">Jangan Lewatkan!  </span><span class="f-light">
                        Fitur terbaru status gizi balita telah tersedia..</span></h6><i class="icon-arrow-top-right f-light"></i>
                </div>
                <div class="d-flex h-100"><img src="{{ asset('images/giftools.gif') }}" alt="gif">
                    <h6 class="mb-0 f-w-400"><span class="f-light">Status gizi balita kini lebih mudah dipantau! </span></h6><a
                        class="ms-1" href="https://1.envato.market/3GVzd" target="_blank"> Cek sekarang!</a>
                </div>
            </div>
        </div>
