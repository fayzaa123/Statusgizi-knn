<div class="sidebar-wrapper" data-sidebar-layout="stroke-svg">
  <div>
    <div class="logo-wrapper"><a href="/"><img class="img-fluid for-light" src="{{ asset('images/logo/logo1.png') }}" alt=""><img class="img-fluid for-dark" src="{{ asset('/images/logo/logo1.png') }}" alt=""></a>
    ...
    <nav class="sidebar-main">
      ...
      <div id="sidebar-menu">
        <ul class="sidebar-links" id="simple-bar">
          <li class="back-btn"><a href="/"><img class="img-fluid" src="{{ asset('images/logo/logo-icon.png') }}"  alt=""></a>
          ...
          <li class="sidebar-list">
            ...
            <li class="sidebar-list">
              <i class="fa-solid fa-thumbtack"></i>
              <a class="sidebar-link sidebar-title link-nav" href="{{ url('user/history') }}">
                  <svg class="stroke-icon">
